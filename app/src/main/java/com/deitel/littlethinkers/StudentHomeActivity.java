...
import com.deitel.littlethinkers.ComplexPuzzle.ComplexPuzzlesActivity;
...
public class StudentHomeActivity extends AppCompatActivity {
    ...
    CardView Shapes, Numbers, cardView, cardView1, TakePicture, puzzles, btnColours, btnComplexPuzzle, btnLifeSkills,
    btnCreateS, btnMath, btnSocialS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnComplexPuzzle = findViewById(R.id.btnComplexPuzzle);
        btnSocialS= findViewById(R.id.btnSocialS);
        btnCreateS = findViewById(R.id.btnCreateSentence);
    ...
    public void MoveToLifeSkills(){
        btnLifeSkills.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent loginInt = new Intent(StudentHomeActivity.this, LifeSkillsHome.class);
                startActivity(loginInt);
            }
        });
    }

    public void MoveToColoursPage(){
        btnColours.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent loginInt = new Intent(StudentHomeActivity.this, ColoursActivity.class);
                startActivity(loginInt);
            }
        });
    ...
    // Method - redirects the user to puzzles page
    public void MoveToComplexPuzzlePage() {
        // When the user clicks on the text -- the login page will open
        btnComplexPuzzle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent puzzles = new Intent(StudentHomeActivity.this, ComplexPuzzlesActivity.class);
                startActivity(puzzles);
            }
        });
    }
    ...
    public void Math() {
        ...
        btnMath.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent puzzles = new Intent(StudentHomeActivity.this, MenuMathNSActivity.class);
                startActivity(puzzles);
            }
        });
    }
    ...
    public void CreateS() {
        ...
        btnCreateS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent puzzles = new Intent(StudentHomeActivity.this, SentencesActivity.class);
                startActivity(puzzles);
            }
        });
    }
    ...
    public void SocialS() {
        ...
        btnSocialS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent puzzles = new Intent(StudentHomeActivity.this, SocialStoriesMenu.class);
                startActivity(puzzles);
            }
        });
    }
