...
public class TheSimpsonsPuzzle extends AppCompatActivity {
    ...
    private static GridViewSimpsons mGridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_the_simpsons_puzzle);
    ...
    private void Hint() {
        imageHint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(TheSimpsonsPuzzle.this);
    ...
    private void init() {
        mGridView = (GridViewSimpsons) findViewById(R.id.gridSims);
    ...
    private static void display(Context context) {
        ...
        for (int i = 0; i < tileList.length; i++) {
            ...
            if (tileList[i].equals("0"))
                button.setBackgroundResource(R.drawable.simone);
            else if (tileList[i].equals("1"))
                button.setBackgroundResource(R.drawable.simtwo);
            else if (tileList[i].equals("2"))
                button.setBackgroundResource(R.drawable.simthree);
            else if (tileList[i].equals("3"))
                button.setBackgroundResource(R.drawable.simfour);
            else if (tileList[i].equals("4"))
                button.setBackgroundResource(R.drawable.simfive);
            else if (tileList[i].equals("5"))
                button.setBackgroundResource(R.drawable.simsix);
            else if (tileList[i].equals("6"))
                button.setBackgroundResource(R.drawable.simseven);
            else if (tileList[i].equals("7"))
                button.setBackgroundResource(R.drawable.simeight);
            else if (tileList[i].equals("8"))
                button.setBackgroundResource(R.drawable.simnine);
