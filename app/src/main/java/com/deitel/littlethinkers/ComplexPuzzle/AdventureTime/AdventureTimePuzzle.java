package com.deitel.littlethinkers.ComplexPuzzle.AdventureTime;
...
public class AdventureTimePuzzle extends AppCompatActivity {
    ...
    private static GridViewAD mGridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adventure_time_puzzle);
    ...
    private void Hint() {
        imageHint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(AdventureTimePuzzle.this);
    ...
    private void init() {
        mGridView = (GridViewAD) findViewById(R.id.gridAD);
    ...
    private static void display(Context context) {
        ...
        for (int i = 0; i < tileList.length; i++) {
            ...
            if (tileList[i].equals("0"))
                button.setBackgroundResource(R.drawable.adone);
            else if (tileList[i].equals("1"))
                button.setBackgroundResource(R.drawable.adtwo);
            else if (tileList[i].equals("2"))
                button.setBackgroundResource(R.drawable.adthree);
            else if (tileList[i].equals("3"))
                button.setBackgroundResource(R.drawable.adfour);
            else if (tileList[i].equals("4"))
                button.setBackgroundResource(R.drawable.adfive);
            else if (tileList[i].equals("5"))
                button.setBackgroundResource(R.drawable.adsix);
            else if (tileList[i].equals("6"))
                button.setBackgroundResource(R.drawable.adseven);
            else if (tileList[i].equals("7"))
                button.setBackgroundResource(R.drawable.adeight);
            else if (tileList[i].equals("8"))
                button.setBackgroundResource(R.drawable.adnine);
